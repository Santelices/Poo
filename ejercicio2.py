...
# en funcion de la distancia que existe entre una direccion de origen y destino.
# Suponga que los envios siempre se despachan desde el mismo origen.
# Para la determinacion de la distancia entre el origen y destino genere numeros aleatorios entre 0 km y 2.000 km
